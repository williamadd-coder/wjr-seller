  ...
  return (
    <div className="shell">
      <aside className="sidebar">
        ...
        <nav className="nav">{nav.map((item, i) => <a className={i === 0 ? "active" : ""} href={i === 1 ? "#studio" : "#"} key={item}>{item}</a>)}</nav>
      </aside>
      <main className="main">
        <section className="hero">
          ...
          <div className="cta"><a className="button primary" href="#studio">Otimizar novo produto</a><a className="button" href="#score">Conhecer o Score WJR</a></div>
        </section>
        <section className="grid">
          <article className="card"><span>Produtos</span><strong>0</strong><p>Base única para todos os marketplaces.</p></article>
          <article className="card"><span>Cadastros prontos</span><strong>0</strong><p>Conteúdo validado antes da publicação.</p></article>
          <article className="card"><span>Score WJR médio</span><strong>—</strong><p>Qualidade do cadastro orientada à conversão.</p></article>
        </section>
