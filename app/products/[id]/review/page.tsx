      ...
      <div className="workspaceGrid reviewGrid">
        ...
        <div className="reviewSidebar">
          <section className="formSection">
            ...
            <AiActionButton action={research} label="Pesquisar anúncios na Shopee" pendingLabel="Pesquisando na Shopee…" hint="A IA está lendo anúncios reais da Shopee. Isso leva de 20 a 40 segundos, não feche esta página." />
